...
final class TimerCondition extends PlannerCondition {
...
/* -- COMMENTED OUT so that i can get TimerCondition working first
   ...
   final class WVM_Condition extends PlannerCondition {
   /*
    ...
    * /
     ...
     * /
     ...
     final class Event_Condition extends PlannerCondition {
     /*
