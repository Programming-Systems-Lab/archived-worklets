...
/**
 * The <code>WKL_Demo_Target</code> class is a graphical demo of the
 * Worklets system that which is intended to recieve the Worklets
 * send from <code>WKL_Demo_Sender</code>.
 *
